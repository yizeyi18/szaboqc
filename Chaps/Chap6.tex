...
而是通过在高至无穷阶上求特定图的和, 近似考虑微扰论中各阶的贡献.
换言之, 他拿到的近似相关能里不仅有高至一定阶(比如, 二阶)的贡献,
还有更高阶项的特定部分.
用这种方法, 他首次完成了一项计算,
...
在量子化学中, 是否认为图解有用且能提供有价值的见解(如提示特定的近似方法),
本质上只是个偏好问题.
我们希望这种简化的讲解能激发部分读者进一步学习这些技术.
